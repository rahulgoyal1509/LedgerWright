...
def run_matching(ledger: list[Transaction], bank: list[Transaction]) -> list[MatchResult]:
    auto_matched, unmatched_ledger, unmatched_bank = prematch(ledger, bank)
...
def run_full_pipeline(
    ...
    results, downgraded = verify_balances(results)
